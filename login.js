async function handleGoogleAuth() {
  ...
  if (error) {
    if (error.message.includes('provider is not enabled')) {
      document.getElementById('loginMsg').textContent = 'O Login com Google não está ativado no teu Supabase Dashboard. Ativa-o em Authentication > Providers.';
    } else {
      document.getElementById('loginMsg').textContent = 'Erro ao autenticar com Google: ' + error.message;
    }
  }
}
